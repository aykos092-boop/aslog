  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (profileData) {
        ...
        // Set subscription data - simplified
        setSubscription(profileData.subscription_id ? { 
          name: profileData.subscription_id,
        ...
        {isEditing && isOwnProfile ? (
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground mb-4">Форма редактирования будет здесь</p>
              <div className="flex gap-2">
                <Button onClick={handleEditComplete}>Сохранить</Button>
          ...
          <>
            ...
            <Tabs defaultValue="ratings" className="w-full">
              ...
              <TabsContent value="verification" className="space-y-4">
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="font-medium mb-4">Верификация</h3>
                    <p className="text-muted-foreground">Форма верификации будет здесь</p>
                  </CardContent>
                </Card>
              </TabsContent>
            </Tabs>
