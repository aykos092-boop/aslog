...
import { sendEmailOTP, verifyEmailOTP } from "@/services/firebaseAuthService";
...
export const EmailOTPInputFirebase = ({ email, type = 'email_verification', onVerified, onError }: EmailOTPInputProps) => {
